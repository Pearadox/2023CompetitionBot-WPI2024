...
public final class Constants {
  ...
  public static final class SwerveConstants{
    ...
    public static final double LEFT_FRONT_OFFSET = 264.375 / 360; //change
    public static final double RIGHT_FRONT_OFFSET = 162.773 / 360; //change
    public static final double LEFT_BACK_OFFSET = 21.621 / 360; //change
    public static final double RIGHT_BACK_OFFSET = 279.580 / 360; //change
